...
<body>
	...
	<div id="container">
		...
		<div id="bv_Form1"
			style="position: absolute; background-color: #F0F0F0; left: 400px; top: 372px; width: 583px; height: 523px; z-index: 4">
			<form name="HospitalAdmin" method="post" action=""
				enctype="text/plain" id="Form1">
				<div id="bv_Image4"
					style="margin: 0; padding: 0; position: absolute; left: 45px; top: 53px; width: 105px; height: 93px; text-align: left; z-index: 0;">
				...
				<div id="bv_Text1"
					...
					<h5>Unauthorized to access this resource, Kindly contact
						System Administrator</h5>
				</div>
				<div id="bv_Image5"
					style="margin: 0; padding: 0; position: absolute; left: 176px; top: 140px; width: 256px; height: 256px; text-align: left; z-index: 2;">
					<img src="${pageContext.request.contextPath}/resources/images/error.png" id="Image5" alt=""
						align="top" border="0" style="width: 256px; height: 256px;">
				</div>
			</form>
		</div>
		<div id="bv_Image2"
		...
		<div id="bv_Image3"
			style="margin: 0; padding: 0; position: absolute; left: 88px; top: 752px; width: 200px; height: 71px; text-align: left; z-index: 6;">
		...
		<div id="bv_Image1"
			style="margin: 0; padding: 0; position: absolute; left: 6px; top: 48px; width: 993px; height: 279px; text-align: left; z-index: 7;">
			<img src="${pageContext.request.contextPath}/resources/images/hospital-art-toy.jpg" id="Image1" alt="" align="top"
