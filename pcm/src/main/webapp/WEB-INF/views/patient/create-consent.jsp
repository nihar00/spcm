	...
	<div id="container">
		...
		<div id="bv_Form1"
			...
			<form:form commandName="consent" method="post"
				...
				<input type="submit" id="Button1" name="create consent" value="Create Consent" style="position: absolute; left: 220px; top: 450px; width: 136px; height: 24px; font-family: Arial; font-size: 13px; z-index: 3">
				...
				<div style="position: absolute; left: 315px; top: 400px; width: 148px; height: 18px; border: 1px #C0C0C0 solid; z-index: 6">
